...
@section('content')
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{route('playlists.deleteSongPlaylist',['songId'=>$song->id,'playlistId'=>$playlist->id])}}">
    ...
    @else
        <div class="container">
            <form action="{{route('comment.createInPlaylist',['playlistId'=>$playlist->id, 'userId' => Auth::id()])}}"
                  method="post">
                @csrf
